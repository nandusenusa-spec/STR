    ...
    <div className="flex-1 space-y-8 p-6 lg:p-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div className="space-y-1">
          <h1 className="font-[var(--font-display)] text-4xl lg:text-5xl tracking-tight">
            HOLA, <span className="text-neon-cyan text-glow-cyan">{displayName}</span>
          </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <div className="lg:row-span-2">
          <Card className="h-full border-neon-magenta/30 bg-gradient-to-b from-neon-magenta/10 to-background overflow-hidden">
            <div className="relative aspect-[9/16] lg:h-full min-h-[400px]">
              ...
              <div className="absolute top-3 left-3 right-3">
                <div className="h-1 bg-white/30 rounded-full overflow-hidden">
                  <div className="h-full w-1/3 bg-neon-magenta rounded-full" />
                </div>
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4">
                <span className="inline-block px-2 py-1 rounded bg-neon-magenta/80 text-xs font-bold text-white mb-2">EVENTO</span>
        ...
        <div className="lg:col-span-2">
          <Card className="border-neon-cyan/30 bg-card h-full">
            <CardContent className="p-5">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/app/feed" className="text-neon-cyan text-xs hover:underline">Ver todos</Link>
              </div>
              
              {/* Wave report cards */}
              <div className="space-y-3 mb-4">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-secondary/50">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-neon-cyan to-cyan-600 flex items-center justify-center">
                  ...
                  <span className="px-2 py-1 rounded bg-neon-lime/20 text-neon-lime text-xs font-bold">BUENO</span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-secondary/50">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-neon-magenta to-pink-600 flex items-center justify-center">
                    <Waves className="w-5 h-5 text-background" />
                  </div>
                  <div className="flex-1">
                  ...
                  <span className="px-2 py-1 rounded bg-neon-orange/20 text-neon-orange text-xs font-bold">REGULAR</span>
                </div>
              </div>

              {/* CTA compartir ola */}
              <Button asChild variant="outline" className="w-full border-neon-cyan/50 text-neon-cyan hover:bg-neon-cyan hover:text-background gap-2">
          ...
          <Card className="border-border bg-card h-full">
            <CardContent className="p-5">
              <div className="flex items-center gap-2 mb-4">
                <Camera className="w-5 h-5 text-neon-lime" />
        ...
        <div className="lg:col-span-2">
          <Card className="border-neon-lime/30 bg-card h-full">
            <CardContent className="p-5">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                ...
                <span className="flex items-center gap-1 px-2 py-1 rounded-full bg-neon-lime/20 text-neon-lime text-xs">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <Link href="/app/events" className="text-neon-lime hover:underline text-xs">Ver horarios</Link>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div>
          <Card className="border-neon-magenta/30 bg-gradient-to-br from-neon-magenta/10 to-background h-full">
            <CardContent className="p-5 flex flex-col justify-center h-full">
              <div className="text-center">
                <div className="w-12 h-12 rounded-full bg-neon-magenta/20 flex items-center justify-center mx-auto mb-3">
                ...
                <Button asChild size="sm" className="bg-neon-magenta text-background hover:bg-neon-magenta/90 gap-1">
          ...
          {sections.map((section, i) => {
            ...
            return (
              <Link key={i} href={section.href} className="group">
                <Card className="cursor-pointer transition-all duration-300 card-glow hover-lift border-border hover:border-neon-cyan/50 bg-card h-full">
                  <CardContent className="p-5">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {section.badge && (
                          <span className="px-2 py-1 rounded-full bg-neon-lime/20 text-neon-lime text-xs font-bold">
                            {section.badge}
                          </span>
                        )}
      ...
      {!profileComplete && (
        <Card className="relative overflow-hidden border-neon-cyan/30 bg-gradient-to-r from-neon-cyan/10 via-neon-magenta/10 to-neon-lime/10">
          <div className="absolute inset-0 grid-bg opacity-20" />
          <CardContent className="relative p-6 lg:p-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-neon-cyan to-neon-magenta flex items-center justify-center glow-cyan">
              ...
              <div className="flex items-center gap-3">
                <Button asChild className="bg-gradient-to-r from-neon-cyan to-neon-magenta text-background font-bold glow-cyan">
                  <Link href="/app/profile">
                    <Zap className="w-4 h-4 mr-2" />
                    Completar perfil
                  </Link>
                </Button>
                <Button variant="outline" asChild className="border-neon-cyan text-neon-cyan hover:bg-neon-cyan hover:text-background">
