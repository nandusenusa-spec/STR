    ...
    <div className="p-8">
      ...
      <div className="bg-white p-6 border border-gray-200">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <a href="/admin/videos" className="p-4 bg-gray-50 hover:bg-gray-100 transition-colors text-center">
            <Video className="w-6 h-6 mx-auto mb-2" />
            <span className="text-sm font-medium">Subir Video</span>
          </a>
          <a href="/admin/events" className="p-4 bg-gray-50 hover:bg-gray-100 transition-colors text-center">
            <Calendar className="w-6 h-6 mx-auto mb-2" />
            <span className="text-sm font-medium">Crear Evento</span>
          </a>
          <a href="/admin/products" className="p-4 bg-gray-50 hover:bg-gray-100 transition-colors text-center">
            <ShoppingBag className="w-6 h-6 mx-auto mb-2" />
            <span className="text-sm font-medium">Nuevo Producto</span>
          </a>
          <a href="/admin/subscriptions" className="p-4 bg-gray-50 hover:bg-gray-100 transition-colors text-center">
