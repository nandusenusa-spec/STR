        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-6">
              ...
              />
              <div>
                <span className="font-bold text-lg uppercase tracking-wide block">COMUNIDAD</span>
                <span className="text-[10px] text-white/50 uppercase tracking-widest">Surf & Skate</span>
              </div>
            </Link>
          ...
          {/* Experience Links */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest mb-4">Experiencia</h4>
            <ul className="space-y-3">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-white/40">
            <p>© {new Date().getFullYear()} Comunidad Surf & Skate. Todos los derechos reservados.</p>
